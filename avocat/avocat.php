...
if ($res && $res->num_rows > 0) {
   ...
   ?>
	...
	<div class="col-div-4-1">
		<div class="box">
			...
			<p class="percent"><i class="fa fa-user icons"></i> 5.674% <span>Since Last Months</span></p>
	...
	<div class="col-div-4-1">
		<div class="box">
			...
			<p class="percent" style="color:red!important"><i class="fa fa-long-arrow-down" ></i> 5.64% <span>Since Last Months</span></p>
 ...
 ;				}
				...
				$sql3="INSERT into notif(id_user, user_type, msg) VALUES ($id_user,'$type','$msg1')" ;
				$res=$conn->query($sql) ;
				if($res)
				{$res3=$conn->query($sql3) ;
