...
$sql2="SELECT a.id_aff, a.commission, av.emailA, av.nomA, av.prenomA, av.id_cin, cp.nomClMor
FROM affaire a
...
$commission=$row2['commission'];
...

    {
        ...
        $date1=date('Y-m-d');
            ...
            $code=uniqid();
            $sql3="INSERT INTO facture (code,designation,montant,dateFact,id_aff,id_pay_numCarte)
            values ('$code','Facture de paiement pour affaire code $affaire', '$montant', '$date1', '$affaire','$num_carte')";
...
<style>body{
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="NotificationClMor.php" class="icon-a"><i class="fa fa-bell icons"></i> &nbsp;&nbsp;Notification</a>
