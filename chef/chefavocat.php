...
<p class="nav"> Table de bord</p>
	...
	<div class="profile">
		...
		<p><?php echo   $_SESSION['nom']."  " . $_SESSION['prenom'].'<br/> '; ?> <i class="fa fa-ellipsis-v dots" aria-hidden="true"></i></p>
	...
	<div class="col-div-4-1">
		<div class="box-1" style="overflow-y:scroll;">
			...
			<?php if (($res3 && $res3->num_rows > 0) || ($res4 && $res4->num_rows>0) ) {
                  echo" <table  >
                <tr> <th>Client </th> <th>Date </th> <th>Heure </th><th>Affaire </th> </tr>";
